...
{
	if([self getBuddyByName: [abuddy getName]] == nil)
	{
...
-(NSString *) getID
{
	...
	[mod_proto replaceOccurrencesOfString:DOTMAC withString:AIM options:NSCaseInsensitiveSearch range:NSMakeRange(0, [mod_proto length])];	

	return [[NSString alloc] initWithFormat:@"%@/%@", [name lowercaseString], mod_proto];
}

-(NSString *) getStartingName
{
